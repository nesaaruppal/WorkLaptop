...
def intro():
    ...
    print("\n")
    print("Rules: There is Player 1 and Player 2, represented by 'X' and 'O'.\nTake turns marking the spaces in a 3*3 grid.\nThe first player who succeeds in placing three of their marks in a horizontal, vertical, or diagonal row wins!")
    print("\n")
...
def isFull(board, symbol_1, symbol_2):
    """Check Board, winner and gives a report"""
    count = 1
    winner = True
    ...
    while count < 10 and winner == True:
        ...
        count += 1
    if winner == False:
        print("Game over! That was fun! Again?")
...
# This function checks if any winner is winning
    ...
    for row in range (0, 3):
        if (board[row][0] == board[row][1] == board[row][2] == symbol_1):
            winner = False
            print("Player " + symbol_1 + ", you WIN!")
   
        elif (board[row][0] == board[row][1] == board[row][2] == symbol_2):
            winner = False
            print("Player " + symbol_2 + ", you WIN!")
